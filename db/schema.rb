...
ActiveRecord::Schema[7.0].define(version: 2023_04_12_153737) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.index ["saver_id"], name: "index_favorites_on_saver_id"
  end
  ...
  add_foreign_key "favorites", "users", column: "saver_id"
